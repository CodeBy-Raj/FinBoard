...
export function AddWidgetDialog() {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-[650px] bg-background grid-rows-[auto_1fr_auto] max-h-[90vh]">
        <DialogHeader>
                ...
                <div className="space-y-2">
                    ...
                    {availableFields.length > 0 ? (
                        ...
                        {availableFields.map(field => (
                            <div key={field.path} className="flex items-center text-sm p-2 rounded-md bg-secondary/50">
                            <div>
